...
export const createNewComboPackage = async (comboPackage, token) => {
  ...
  try {
    ...
    const body = comboPackage; //we are sending the formData to get posted on the backend

    const response = await axios.post(`${API}/api/combo-package`, body, config); //handing the backedn register user
